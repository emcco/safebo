...
class OptMax:
    def __init__(self, test_x, model, jmin, Lk, Lmean):
        ...
        self.Lk = Lk
        self.Lmean = Lmean
        self.mean, self.lower, self.upper = gpm.get_mean_bounds(model, test_x, Lk, Lmean)
    ...
    def objective(self, x):
        ...
        mean_max, lower_max, upper_max = gpm.get_mean_bounds(self.model, x, self.Lk, self.Lmean)
    ...
    def constraintMax(self, x):
        ...
        upper_x = gpm.get_mean_bounds(self.model, x, self.Lk, self.Lmean)[2]
    ...
    def constraintSafety(self, x):
        ...
        lower_x = gpm.get_mean_bounds(self.model, x, self.Lk, self.Lmean)[1]
        jmin = self.jmin
        c_safe = lower_x - jmin
        return c_safe
