...
class ModSafeOpt:
    def __init__(self, x0_max, x0_exp, test_x, model, jmin, flag):
        self.x0_max = x0_max
        self.x0_exp = x0_exp
        self.test_x = test_x
        self.model = model
    ...
    def sample(self):
        ...
        # initial maximiser
        optimizer = optMax.OptMax(self.test_x, initial_model, self.jmin)
        ...
        mean, lower_max, upper_max = gpm.get_bounds_RKHS(initial_model, x_new_max)
        ...
        # initial expander
        optimizer_exp = optExp.OptExp(self.test_x, initial_model, self.jmin)
        result_exp = None
        var_exp = None
        warn_string = None
        ...
        if self.flag == False:
            ...
            mean_exp, lower_exp, upper_exp = gpm.get_bounds_RKHS(initial_model, x_new_exp)
